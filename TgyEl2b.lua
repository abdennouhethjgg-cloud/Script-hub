...
local SammyDB = {
    ...
    ["my youtube"] = "YOUTUBE",
    ["sammy youtube"] = "YOUTUBE",

    ["game name"] = "STEALABRAINROT",
    ["name of the game"] = "STEALABRAINROT",
    ["sab"] = "STEALABRAINROT",
    ["sab stands for"] = "STEAL A BRAINROT",
    ["full name"] = "STEAL A BRAINROT",
    ["game created on"] = "MAY162025",
    ["created on"] = "MAY162025",
    ["game creation day"] = "MAY162025",
    ["release month"] = "MAY",
    ["release year"] = "2025",
    ...
    ["day sab was made"] = "16",
    ["sab release day"] = "16",
    ["game made on"] = "MAY162025",
    ["sab made on"] = "MAY162025",
    ["year made"] = "2025",
    ...
    ["BLUEBLUE"] = "BLUEBLUE",
    ["BLUEBLUEBLUE"] = "BLUEBLUEBLUE",
    ["FOOTBALLFOOTBALL"] = "FOOTBALLFOOTBALL",
    ...
    ["yellow mutation"] = "GOLD",
    ["turns yellow"] = "GOLD",
    ["yellow"] = "GOLD",
    ["red mutation"] = "BLOODROT",
    ["turns red"] = "BLOODROT",
    ["red"] = "BLOODROT",
    ...
    ["rarest brainrot"] = "STRAWBERRYELEPHANT",
    ["rarest"] = "STRAWBERRYELEPHANT",
    ["best brainrot"] = "STRAWBERRYELEPHANT",
    ["unobtainable"] = "STRAWBERRYELEPHANT",
    ["highest rarity"] = "OG",
    ["OG"] = "OG",
    ["rarest rarity"] = "OG",
    ["top rarity"] = "OG",
    ...
    ["HEADLESSHORSEMAN"] = "HEADLESSHORSEMAN",
}
...
-- // [3] RECURSIVE UI CONSTRUCTION // --
local old = PlayerGui:FindFirstChild("EL2BHUBUI")
if old then old:Destroy() end

local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "EL2BHUBUI"
...
PillFrame.Size = UDim2.new(0, 292, 0, 44)
PillFrame.Position = UDim2.new(0.5, -146, 0, 14)
PillFrame.BackgroundColor3 = Color3.fromRGB(20, 20, 24)
PillFrame.BackgroundTransparency = 0.04
...
PillCorner.CornerRadius = UDim.new(0, 22)
PillCorner.Parent = PillFrame

local PillStroke = Instance.new("UIStroke")
PillStroke.Color = Color3.fromRGB(70, 70, 85)
PillStroke.Thickness = 1.15
PillStroke.Transparency = 0.32
...
PillText.Size = UDim2.new(0, 138, 1, 0)
PillText.Position = UDim2.new(0, 32, 0, 0)
PillText.BackgroundTransparency = 1
PillText.Text = "EL2B HUB"
PillText.TextColor3 = Color3.fromRGB(238, 238, 245)
...
StatsBadge.Size = UDim2.new(0, 76, 0, 22)
StatsBadge.Position = UDim2.new(1, -158, 0.5, -11)
StatsBadge.BackgroundColor3 = Color3.fromRGB(30, 30, 38)
StatsBadge.BorderSizePixel = 0
StatsBadge.ZIndex = 11
StatsBadge.Parent = PillFrame

local StatsCorner = Instance.new("UICorner")
StatsCorner.CornerRadius = UDim.new(0, 11)
...
StatsText.TextColor3 = Color3.fromRGB(170, 170, 185)
...
StartPillBtn.Position = UDim2.new(1, -84, 0.5, -13)
...
ExpandBtn.Position = UDim2.new(1, -28, 0.5, -11)
ExpandBtn.BackgroundColor3 = Color3.fromRGB(36, 36, 44)
ExpandBtn.Text = "▼"
ExpandBtn.TextColor3 = Color3.fromRGB(195, 195, 210)
...
ExpandCorner.CornerRadius = UDim.new(0, 11)
...
TrayFrame.Position = UDim2.new(0, 0, 1, 5)
TrayFrame.BackgroundColor3 = Color3.fromRGB(15, 15, 19)
TrayFrame.BackgroundTransparency = 0.02
...
TrayCorner.CornerRadius = UDim.new(0, 14)
TrayCorner.Parent = TrayFrame

local TrayStroke = Instance.new("UIStroke")
TrayStroke.Color = Color3.fromRGB(50, 50, 62)
TrayStroke.Thickness = 1
TrayStroke.Transparency = 0.4
...
FooterLabel.Text = "EL2B HUB"
FooterLabel.TextColor3 = Color3.fromRGB(105, 105, 125)
FooterLabel.Font = Enum.Font.GothamMedium
FooterLabel.TextSize = 11
FooterLabel.ZIndex = 11
FooterLabel.Parent = TrayInner

local FooterLink = Instance.new("TextLabel")
FooterLink.Name = "FooterLink"
FooterLink.Size = UDim2.new(1, 0, 0, 13)
FooterLink.Position = UDim2.new(0, 0, 1, -6)
FooterLink.BackgroundTransparency = 1
FooterLink.Text = "https://discord.gg/bzyNGBVEz4"
FooterLink.TextColor3 = Color3.fromRGB(80, 130, 210)
FooterLink.Font = Enum.Font.Gotham
FooterLink.TextSize = 10
FooterLink.ZIndex = 11
FooterLink.Parent = TrayInner

local CounterBadge = Instance.new("Frame")
CounterBadge.Name = "CounterBadge"
CounterBadge.Size = UDim2.new(0, 52, 0, 20)
CounterBadge.Position = UDim2.new(0, 10, 0, 6)
CounterBadge.BackgroundColor3 = Color3.fromRGB(35, 35, 45)
CounterBadge.Visible = false
CounterBadge.BorderSizePixel = 0
CounterBadge.ZIndex = 12
CounterBadge.Parent = TrayFrame
...
local function answerRiddle(question)
    ...
    if NormalizedDB[key] then
        return NormalizedDB[key]
    end
...
-- Find textboxes that look like code / answer / chat inputs
local function findRelevantTextBoxes()
    local results = {}
    for _, obj in ipairs(PlayerGui:GetDescendants()) do
        if obj:IsA("TextBox") then
            local n = string.lower(obj.Name)
            if n:find("code") or n:find("redeem") or n:find("answer") or n:find("riddle")
            or n:find("chat") or n:find("message") or n:find("input") or n:find("text") then
...
-- Fire any Confirm / Submit / Redeem style button
local function fireConfirmButtons()
    for _, obj in ipairs(PlayerGui:GetDescendants()) do
        if obj:IsA("GuiButton") then
            local n = string.lower(obj.Name)
            local t = string.lower(obj.Text or "")
            if n:find("confirm") or n:find("submit") or n:find("redeem") or n:find("send")
            or t:find("confirm") or t:find("submit") or t:find("redeem") or t:find("send") then
                pcall(function()
                ...
                if (label:IsA("TextLabel") or label:IsA("TextButton")) and label.Text then
                    ...
                    if #txt > 3 and #txt < 90 then
                        ...
                        if ans and ans ~= lastAnswer then
                            ...
                            fireConfirmButtons()
                            currentCount += 1
                            CounterText.Text = currentCount .. "/" .. selectedMessages
...
StartPillBtn.MouseButton1Click:Connect(function()
    ...
    if isSniping then
        ...
        StartPillBtn.BackgroundColor3 = Color3.fromRGB(190, 60, 60)
...
AutoRiddleBtn.MouseButton1Click:Connect(function()
    ...
    AutoRiddleBtn.BackgroundColor3 = autoRiddle and Color3.fromRGB(42, 100, 62) or Color3.fromRGB(28, 28, 36)
end)

local function selectMessageCount(n)
    selectedMessages = n
    currentCount = 0
    CounterText.Text = "0/" .. n
    CounterBadge.Visible = true

    local list = {Msg1Btn, Msg2Btn, Msg3Btn, Msg4Btn}
    for i, btn in ipairs(list) do
        btn.BackgroundColor3 = (i == n) and Color3.fromRGB(48, 92, 150) or Color3.fromRGB(28, 28, 36)
    end
end
...
_G.EL2BHUB = {
    Start = function()
        if not isSniping then
            StartPillBtn.MouseButton1Click:Fire()
        end
    end,
    Stop = function()
        if isSniping then
    ...
    ToggleAutoRiddle = function()
        AutoRiddleBtn.MouseButton1Click:Fire()
    end,
...
print("══════════════════════════════════════")
print("  EL2B HUB  |  FULL SOURCE")
print("  • UI + complete Sammy riddle DB")
print("  • Auto Riddle scanner")
print("  • Code / Confirm button firer")
print("  • No key required")
print("  • _G.AnswerSammy(\"question\")")
print("  • _G.EL2BHUB.Start() / Stop()")
print("══════════════════════════════════════")
